...
<table>
		...
		foreach ($nomina as $nomina_item):
			...
			echo form_open('SalaryManagementAdminCompensa/proponerCompensacion');
			?>
			<tr>
			...
			<tr>
				<td><b>Eval. Desemp. </b><br><?=$nomina_item['comp_eval_desempeno']?>
				<td><b>Rango </b><br><?=$nomina_item['comp_pos_de_rango']?></td>
				<td><b>Prioridad Ajuste</b><br><?=$nomina_item['comp_prioridad_ajuste']?></td>
				<td><b>Comp-Ratio</b><br>TBD</td>
				<td><b>Pauta </b><br><?=$nomina_item['comp_pauta']?></td>
...
<div id="nuevoSalario" class="tabcontent" name="nuevoSalario">
	<table>
		...
		foreach ($nomina as $nomina_item):
			echo validation_errors();
			echo form_open('SalaryManagementAdminCompensa/proponerPorcentajeSalario');
			?>
			<tr>
				<td><input type="text" size="8" id="txtLegajo" name="txtLegajo" value="<?php echo $nomina_item['legajo']?>"/></td>
			...
			?>
				<td><input type="submit" id="finalizar" name="finalizar" value="Finalizar"/></td>
				<td><input type="submit" id="revisar" name="revisar" value="Revisar"/></td>
			<?php
				}
			?>	
			...
			?>
				<td><input type="submit" id="notificar" name="notificar" value="Notificar"/></td>
			<?php
				}
			?>	
...
<div id="comentarios" class="tabcontent" name="comentarios">
	...
	<table>
		...
		foreach ($nomina as $nomina_item):
			echo validation_errors();
			echo form_open('SalaryManagementAdminCompensa/updateObservaciones');
		?>
			<tr>
				<td><input type="text" size="8" id="txtLegajo" name="txtLegajo" value="<?php echo $nomina_item['legajo'];?>"/></td>
				<td><?php echo $nomina_item['nombre_completo'];?></td>
